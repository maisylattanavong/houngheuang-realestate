...
@section('frontend')
    ...
    {{-- <div class="inside-banner">
        <div class="container">
            <span class="pull-right"><a href="{{ route('index') }}">@lang('frontend.home')</a> / @lang('frontend.all_properties')</span>
            <h2>@lang('frontend.all_properties')</h2>
        </div>
    </div> --}}
    <!-- banner -->
    <div class="container">
            ...
            <div class="row">
                        ...
                        @forelse ($allProperties as $item)
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-7">
                                    <h5><a href="{{ route('property.detail', $item->id) }}">{{ $item->title }}</a></h5>
                ...
                <div class="col-lg-9 col-sm-8">
                    <div class="sortby clearfix">
                        {{-- <div class="pull-left result">@lang('frontend.showing') 12 @lang('frontend.of') 100 </div> --}}
                        ...
                        @forelse ($allProperties as $item)
                            <div class="col-lg-4 col-sm-6">
                                <div class="properties">
                                    ...
                                    {{-- <p class="price">Area: {{ $item->area }} m&sup2</p> --}}
                    ...
                    <!-- properties -->
                    @if (!is_null($allProperties))
                        <div class="center">
                            {{ $allProperties->links('pagination::bootstrap-4') }}
                        </div>
                    @endif
                </div>
            </div>
