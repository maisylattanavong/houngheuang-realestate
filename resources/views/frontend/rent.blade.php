...
@section('frontend')
    ...
    {{-- <div class="inside-banner">
        <div class="container">
            <span class="pull-right"><a href="{{ route('index') }}">@lang('frontend.home')</a> / @lang('frontend.rent_properties')</span>
            <h2>@lang('frontend.rent_properties')</h2>
        </div>
    </div> --}}
    <!-- banner -->
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4 ">
                    ...
                    <div class="hot-properties hidden-xs">
                        ...
                        @forelse ($hot_rent_properties as $item)
                            <div class="row">
