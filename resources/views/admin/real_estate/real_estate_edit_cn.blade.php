    ...
    @if (Auth::user()->can('property.edit'))
        <div class="page-content">
            <div class="container post-container">
                <form method="post" action="{{ route('update.chinese.realestate') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-lg-12 right-container" style="border-radius:6px;">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="card-header pb-3 pt-3">
                                            @lang('backend.translate_into_chinese')
                                        </div>
                                        <div class="card-body">
                                            <div class="row mb-3" style="display: flex; flex-direction:column">
                                                <label for="example-text-input"
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="hidden" name="cn_id" value="{{ $cn_realestate->id }}">
                                                    <input class="form-control" name="title" type="text"
                                                        value="{{ $cn_realestate->title }}" id="example-text-input"
                                                        placeholder=" @lang('backend.realestate_title_placeholder') ">
                                                    <span class="text-danger">
                                                        @error('title')
                                                            {{ $message }}
                                            ...
                                            <div class="row mb-3" style="display: flex; flex-direction:column">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" name="address" type="text"
                                                        value="{{ $cn_realestate->address }}" id="example-text-input"
                                                        placeholder=" @lang('backend.realestate_address_placeholder') ">
                                                    <span class="text-danger">
                                                        @error('address')
                                                            {{ $message }}
                                            ...
                                            <div class="row mb-3" style="display: flex; flex-direction:column">
                                                <label for="example-text-input" class="col-sm-6 col-form-label">
                                                    @lang('backend.description') &nbsp; <span class="fi fi-cn"></span>&nbsp;
                                                    (CN)</label>
                                                <div class="col-sm-12">
                                                    <textarea id="elm2" name="description" placeholder="@lang('backend.realestate_desc_placeholder')" style="border: 1px solid red">{{ $cn_realestate->description }}</textarea>
                                                </div>
                                                <span class="text-danger">
                                                    @error('description')
                                                        {{ $message }}
