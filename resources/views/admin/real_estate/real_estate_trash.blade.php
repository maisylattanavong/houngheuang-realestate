                    ...
                    <div class="card">
                        <div class="card-body">
                            <div style=" display:flex; align-items:center;justify-content:space-between">
                                <h6 style="text-align: start; margin-left:2%" class="mt-3">@lang('backend.all_trased')</h6>
                            </div>
                                    ...
                                    @foreach ($trashed as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if (Auth::user()->can('property.restore.delete'))
                                                <a href="{{ route('realestate.restore.trashed', $item->id) }}"
                                                    class="btn btn-info btn-sm" title="Edit Data">
                                                    <i class="fa-solid fa-reply"></i>&nbsp;&nbsp;@lang('backend.restore_button')
                                                </a>
                                                @endif

                                                @if (Auth::user()->can('property.force.delete'))
                                                <a href="{{ route('realestate.force.delete.trashed', $item->id) }}" id="delete"
